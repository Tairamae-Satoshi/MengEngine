...
namespace Graphics
{
	...
	std::shared_ptr<Graphics::GpuResourceDescriptor> GpuRenderTextureDepth::CreateDSV()
	{
	...
	std::shared_ptr<Graphics::GpuResourceDescriptor> GpuRenderTextureDepth::CreateDepthSRV()
	{
	...
	std::shared_ptr<Graphics::GpuResourceDescriptor> GpuRenderTextureDepth::CreateStencilSRV()
	{
		std::shared_ptr<GpuResourceDescriptor> descriptor = std::make_shared<GpuResourceDescriptor>(D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV, shared_from_this());

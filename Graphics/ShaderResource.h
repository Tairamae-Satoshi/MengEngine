...
{
    template<>
    struct hash<Graphics::ShaderResourceAttribs>
    {
        size_t operator()(const Graphics::ShaderResourceAttribs& attribs) const
        {
    ...
    template<>
    struct hash<Graphics::ShaderResource>
    {
        size_t operator()(const Graphics::ShaderResource& shaderResource) const
        {
